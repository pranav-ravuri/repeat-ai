<script lang="ts">
	...
	const { slice, caseStudies = [] }: Props = $props();
</script>
...
<style>
	.image-glow {
		@apply absolute h-1/2 w-1/2 rounded-full opacity-0 mix-blend-screen blur-[64px] transition-opacity duration-500 group-hover:opacity-30;
	}
</style>
