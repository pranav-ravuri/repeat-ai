...
/**
 * Item in *Bento → Default → Primary → Zones*
 */
export interface BentoSliceDefaultPrimaryZonesItem {
	/**
	 * Title field in *Bento → Default → Primary → Zones*
	 *
	 * - **Field Type**: Rich Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: bento.default.primary.zones[].title
	 * - **Documentation**: https://prismic.io/docs/fields/rich-text
	 */
	title: prismic.RichTextField;

	/**
	 * Body field in *Bento → Default → Primary → Zones*
	 *
	 * - **Field Type**: Rich Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: bento.default.primary.zones[].body
	 * - **Documentation**: https://prismic.io/docs/fields/rich-text
	 */
	body: prismic.RichTextField;

	/**
	 * Image field in *Bento → Default → Primary → Zones*
	 *
	 * - **Field Type**: Image
	 * - **Placeholder**: *None*
	 * - **API ID Path**: bento.default.primary.zones[].image
	 * - **Documentation**: https://prismic.io/docs/fields/image
	 */
	image: prismic.ImageField<never>;

	/**
	 * Wide field in *Bento → Default → Primary → Zones*
	 *
	 * - **Field Type**: Boolean
	 * - **Placeholder**: *None*
	 * - **Default Value**: false
	 * - **API ID Path**: bento.default.primary.zones[].wide
	 * - **Documentation**: https://prismic.io/docs/fields/boolean
	 */
...
export interface BentoSliceDefaultPrimary {
	...
	/**
	 * Zones field in *Bento → Default → Primary*
	 *
	 * - **Field Type**: Group
	 * - **Placeholder**: *None*
	 * - **API ID Path**: bento.default.primary.zones[]
	 * - **Documentation**: https://prismic.io/docs/fields/repeatable-group
	 */
	zones: prismic.GroupField<Simplify<BentoSliceDefaultPrimaryZonesItem>>;
}
...
export interface IntegrationsSliceDefaultPrimaryIntegrationsItem {
	/**
	 * Icon field in *Integrations → Default → Primary → Integrations*
	 *
	 * - **Field Type**: Select
	 * - **Placeholder**: *None*
	 * - **API ID Path**: integrations.default.primary.integrations[].icon
...
declare module '@prismicio/client' {
	...
	namespace Content {
		export type {
			...
			AllDocumentTypes,
			BentoSlice,
			BentoSliceDefaultPrimaryZonesItem,
